...
export const NodeApiURL = Object.freeze({
   ADMINLOGIN : adminApi +'/login', //teachers
   getProfession : teachersApi +'/getProfession',
   getQualificationAll : teachersApi +'/getQualificationAll',
   getQualification : teachersApi +'/getQualification',
   ADDTEACHERS : teachersApi +'/addTeachers',
   EDITTEACHERS : teachersApi +'/editTeachers',
   GETTEACHERS : teachersApi +'/getTeachers',
   ALLTEACHERS : teachersApi +'/allTeachers',
   UPDATETEACHERS : teachersApi +'/updateTeachers',
   UPDATETEACHERSIMG : teachersApi +'/updateTeachersImg',
   REMOVETEACHERSIMG : teachersApi +'/removeTeachersImg',
   DELETETEACHERS : teachersApi +'/deleteTeachers',
   DELETEALLTEACHERS : teachersApi +'/deleteAllTeachers',//Products
